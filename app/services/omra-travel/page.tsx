        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            <div className="relative h-80 rounded-xl overflow-hidden mb-6">
              <Image 
                src="/images/omra-travel/Umrah.jpg"
                alt="Omra Travel"
                fill
            ...
            <h1 className="text-4xl font-bold text-white mb-4">Omra Travel</h1>
            <p className="text-slate-300 text-lg mb-6">
              Premium spiritual journey packages including VIP accommodation and professional guides.
            </p>
          ...
          <ServiceInquiry serviceName="Omra Travel" />
        </div>
      </div>
    </div>
  )
